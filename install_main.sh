...
sudo apt-get install git gparted mc mcedit vim virtualbox-dkms virtualbox docker.io remmina remmina-plugin-rdp chromium-browser fish vagrant xbacklight xbindkeys gnome-system-monitor httpie python-pip rar unrar maven -y
